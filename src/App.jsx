...
import kyoshi from "./images/kyoshi.png";
...
function App() {
  ...
  return (
    ...
    <div
      className="min-h-screen bg-black text-white text-center body"
      style={{ backgroundImage: kyoshi }}
    >
      <div className="back">
        {" "}
        <img src={kyoshi} alt="kyoshi" />
      </div>

      <header className="p-6 mb-8">
        <h1 className="text-2xl font-bold uppercase">Kyoshi Hiragana Quiz</h1>
        <div>
          <p>
            {streak} / {maxStreak}
          </p>
      ...
      <div className="mb-8">
        <form onSubmit={handleSubmit}>
          <input
            ...
            value={input}
            className="block w-24 bg-transparent border-b-2 border-b-white mx-auto outline-none text-center text-6xl pb-2 text-red"
          />
        </form>
      </div>
      {error && (
